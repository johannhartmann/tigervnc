...
// RFB H.264 frame-header flag bits. ResetAllContexts (0x2) is reserved
// by the protocol but not currently emitted by this encoder; we drop a
// region by deleting its context locally instead.
namespace {
