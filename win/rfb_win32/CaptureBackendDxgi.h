...
//
// IDXGIOutputDuplication-backed implementation: D3D11 device, output
// enumeration, AcquireNextFrame loop, dirty / move rectangle parsing,
// separate pointer-shape channel, CPU readback through a staging
// texture. The build's Windows 10 baseline guarantees DXGI 1.2 is
// available.
