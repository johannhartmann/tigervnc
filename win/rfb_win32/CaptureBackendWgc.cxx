...
bool WindowsGraphicsCaptureBackend::probe() {
  ...
  // GetProcAddress returns FARPROC (long long int(*)()), and casting it
  // straight to a pointer with arguments trips MinGW GCC's
  // -Wcast-function-type. The void* trampoline is the standard
  // workaround.
